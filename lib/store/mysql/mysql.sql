...
CREATE TABLE IF NOT EXISTS wpr_oauth_log (
...
CREATE TABLE IF NOT EXISTS wpr_oauth_consumer_registry (
...
CREATE TABLE IF NOT EXISTS wpr_oauth_consumer_token (
    ...
    foreign key (oct_ocr_id_ref) references wpr_oauth_consumer_registry (ocr_id)
        on update cascade
        on delete cascade
...
CREATE TABLE IF NOT EXISTS wpr_oauth_server_registry (
    ...
    osr_allowed_calls			int(11) not null default 0,
    osr_calls					int(11) not null default 0,
    osr_last_call				int(11) not null default 0,
    osr_standby					int(1) not null default 0,
...
CREATE TABLE IF NOT EXISTS wpr_oauth_server_nonce (
...
CREATE TABLE IF NOT EXISTS wpr_oauth_server_token (
	...
	foreign key (ost_osr_id_ref) references wpr_oauth_server_registry (osr_id)
        on update cascade
        on delete cascade
